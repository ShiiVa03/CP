...
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataNVL}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{gaux22}}{\succ \comp \p2\comp \p2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{gaux22}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}(\Varid{x}\mathbin{+}\Varid{len}\mathbin{*}\Varid{avg})\mathbin{/}(\mathrm{1}\mathbin{+}\Varid{len}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[4]{}\hsindent{5}{}\<[9]%
\>[9]{}\Varid{avgLTreeaux}\;((\Varid{avgLeft},\Varid{lenLeft}),(\Varid{avgRight},\Varid{lenRight}))\mathrel{=}((\Varid{avgLeft}\mathbin{*}\Varid{lenLeft})\mathbin{+}(\Varid{avgRight}\mathbin{*}\Varid{lenRight}))\mathbin{/}(\Varid{lenLeft}\mathbin{+}\Varid{lenRight}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
