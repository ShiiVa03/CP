...
\\
\>[B]{}\Varid{optmize\char95 eval}\;\Varid{a}\mathrel{=}\Varid{hyloExpAr}\;(\Varid{g\char95 eval\char95 exp}\;\Varid{a})\;\Varid{clean}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpAr}\mathbin{::}\Conid{ExpAr}\;\Varid{a}\to \Conid{OutExpAr}\;\Varid{a}{}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}}}}
&
    \ensuremath{\Conid{OutExpAr}\;\Conid{A}}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\underline{\Varid{a}}}{\alt{\Varid{id}}{\alt{\uncurry{\Varid{binOp}}}{\uncurry{\Varid{unOp}}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{binOp}\;\Conid{Sum}\mathrel{=}\uncurry{(\mathbin{+})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{binOp}\;\Conid{Product}\mathrel{=}\uncurry{(\mathbin{*})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{unOp}\;\Conid{Negate}\mathrel{=}\Varid{negate}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{unOp}\;\Conid{E}\mathrel{=}\Varid{expd}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}i_2\comp i_2\comp i_1\mathbin{\$}(\Varid{op},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}i_2\comp i_2\comp i_2\mathbin{\$}(\Varid{op},\Varid{a}){}\<[E]%
\\
\>[B]{}\mbox{\commentbegin 
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{sd1}}{\alt{\Varid{sd2}}{\alt{\Varid{sd3}}{\Varid{sd4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd1}\;\Varid{x}\mathrel{=}(\Conid{X},(\Conid{N}\;\mathrm{1})){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd2}\;\Varid{y}\mathrel{=}((\Conid{N}\;\Varid{y}),(\Conid{N}\;\mathrm{0})){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c})){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd4}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{sd4}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g1}\;\Varid{x}\mathrel{=}(\Varid{v},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g2}\;\Varid{y}\mathrel{=}(\Varid{y},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}\mathbin{*}\Varid{c},(\Varid{a}\mathbin{*}\Varid{d})\mathbin{+}(\Varid{b}\mathbin{*}\Varid{c})){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g4}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}((\Varid{expd}\;\Varid{a}),(\Varid{expd}\;\Varid{a})\mathbin{*}\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g4}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}((\Varid{negate}\;\Varid{a}),\Varid{negate}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\Varid{c}\;\Varid{n})\mathbin{*}\Varid{f}\;\Varid{n})\mathbin{\Varid{`div`}}\Varid{h}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{faux}\;\Varid{n}\mathbin{+}\Varid{f}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{faux}\;\mathrm{0}\mathrel{=}\mathrm{10}{}\<[E]%
\\
\>[B]{}\Varid{faux}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{8}\mathbin{+}\Varid{faux}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{h}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{haux}\;\Varid{n}\mathbin{+}\Varid{h}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{haux}\;\mathrm{0}\mathrel{=}\mathrm{4}{}\<[E]%
\\
\>[B]{}\Varid{haux}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{2}\mathbin{+}\Varid{haux}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{f},\Varid{faux},\Varid{h},\Varid{haux})\mathrel{=}((\Varid{c}\mathbin{*}\Varid{f})\mathbin{\Varid{`div`}}\Varid{h},\Varid{faux}\mathbin{+}\Varid{f},\mathrm{8}\mathbin{+}\Varid{faux},\Varid{haux}\mathbin{+}\Varid{h},\mathrm{2}\mathbin{+}\Varid{haux}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{10},\mathrm{2},\mathrm{4}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{c},\Varid{f},\Varid{faux},\Varid{h},\Varid{haux})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\>[B]{}\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{c}\;\Varid{n})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\div (\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f}\;\Varid{n}\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{faux}\;\Varid{n}\mathrel{=}\mathrm{8}\;\Varid{n}\mathbin{+}\mathrm{10}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{haux}\;\Varid{n}\mathrel{=}\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{4}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\mathrel{=}\alt{\Varid{h1}}{\Varid{h2}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h1}\;\Varid{x}\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h2}\;(\Varid{d},\Varid{f})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h2}\;(\Varid{d},\Varid{f})\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\lambda \Varid{z}\to \Varid{concat}\mathbin{\$}(\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{d}\;\Varid{x},\Varid{f}\;\Varid{xs}\mskip1.5mu])\;\Varid{z}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Q}\mathbin{*}\Conid{NPoint}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\mathbin{*}\Varid{calcLine}}}
           \ar[l]_-{\ensuremath{\mathbf{in}}}
\\
     \ensuremath{(\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint})}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Q}\mathbin{*}(\Conid{Npoint}\to \Conid{OverTime}\;\Conid{NPoint})} 
...
\>[B]{}\Varid{deCasteljau}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\;\Varid{l}\mathrel{=}(\Varid{hyloAlgForm}\;\Varid{alg}\;\Varid{coalg})\;\Varid{l}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\mathrel{=}(\Varid{id}+\conj{\Varid{cons}\comp (\Varid{id}\times\Varid{init})}{\p2})\comp \Varid{outNVL}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\mathrel{=}\alt{\Varid{alg1}}{\Varid{alg2}}\;\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{2}{}\<[6]%
\>[6]{}\Varid{alg1}\;\Varid{x}\mathrel{=}\underline{\Varid{x}}{}\<[E]%
\\
\>[4]{}\hsindent{2}{}\<[6]%
\>[6]{}\Varid{alg2}\;(\Varid{f},\Varid{g})\mathrel{=}\lambda \Varid{pt}\to \Varid{calcLine}\;(\Varid{f}\;\Varid{pt})\;(\Varid{g}\;\Varid{pt})\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=3cm{
    \ensuremath{[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]}
           \ar[d]^-{\ensuremath{\Varid{coalg}}}
           \ar[r]^-{\ensuremath{(\Varid{id}\mathbin{*}\conj{\Varid{cons}\comp (\Varid{id}\times\Varid{init})}{\p2})\comp \Varid{outNVL}}}
&
    \ensuremath{\Conid{NPoint}\mathbin{+}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\mathbin{*}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{coalg}\mathbin{*}\Varid{coalg}}}           
\\
     \ensuremath{\mathsf{LTree}\;\Conid{NPoint}}
&
     \ensuremath{\Conid{NPoint}\mathbin{+}\mathsf{LTree}\;\Conid{NPoint}\mathbin{*}\mathsf{LTree}\;\Conid{NPoint}} 
        \ar[l]^-{\ensuremath{\Varid{inLTree}}}          
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Conid{NPoint}}
           \ar[d]_-{\ensuremath{\Varid{alg}}}
&
    \ensuremath{\Conid{NPoint}\mathbin{+}\mathsf{LTree}\;\Conid{NPoint}\mathbin{*}\mathsf{LTree}\;\Conid{NPoint}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{alg}\mathbin{*}\Varid{alg}}}
           \ar[l]_-{\ensuremath{\mathbf{in}}}
\\
     \ensuremath{\Conid{OverTime}\;\Conid{NPoint}}
&
     \ensuremath{\Conid{NPoint}\mathbin{+}\Conid{OverTime}\;\Conid{NPoint}\mathbin{*}\Conid{OverTime}\;\Conid{NPoint}} 
           \ar[l]^-{\ensuremath{\alt{\Varid{alg1}}{\Varid{alg2}}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\mathbin{*}(\Conid{A}\mathbin{*})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\mathbin{*}\mathbin{<}\Varid{avg},\length \mathbin{>}}}
           \ar[l]_-{\ensuremath{\Varid{inNVL}}}
\\
     \ensuremath{\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\mathbin{*}(\Conid{A}\mathbin{*}\Conid{A})} 
           \ar[l]^-{\ensuremath{\Varid{len\char95 gen}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{len\char95 gen}\mathrel{=}[\mskip1.5mu \Varid{g1},\Varid{g2}\mskip1.5mu]\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\Varid{g1}\;\Varid{x}\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{g2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{len}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
	\ensuremath{\Varid{g1}\;\Varid{x}\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]}
%
...
\begin{eqnarray*}
\start
	\ensuremath{\Varid{g2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{len}}
%
\just\equiv{ def. succ }
%
  \ensuremath{\Varid{g2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}\succ \;\Varid{len}}
%
\just\equiv{ def.comp, def.proj }
%
  \ensuremath{\Varid{g2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}\succ \comp \p2\comp \p2\;(\Varid{x},(\Varid{avg},\Varid{len}))}
\just\equiv{ igualdade extensional}
    \ensuremath{\Varid{g2}\mathrel{=}\succ \comp \p2\comp \p2}
\qed
\end{eqnarray*}
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inNVL}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outNVL}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outNVL}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}i_2\;(\Varid{a},\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recNVL}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataNVL}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recNVL}\;(\Varid{cataNVL}\;\Varid{g})\comp \Varid{outNVL}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataNVL}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{algorit}}{\succ \comp \p2\comp \p2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{algorit}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}(\Varid{x}\mathbin{+}\Varid{len}\mathbin{*}\Varid{avg})\mathbin{/}(\mathrm{1}\mathbin{+}\Varid{len}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{avgLTreeaux}}{\uncurry{(\mathbin{+})}\comp (\p2\times\p2)}}\;\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{5}{}\<[9]%
\>[9]{}\Varid{avgLTreeaux}\;((\Varid{avgLeft},\Varid{lenLeft}),(\Varid{avgRight},\Varid{lenRight}))\mathrel{=}{}\<[E]%
\\
\>[9]{}\hsindent{24}{}\<[33]%
\>[33]{}((\Varid{avgLeft}\mathbin{*}\Varid{lenLeft})\mathbin{+}(\Varid{avgRight}\mathbin{*}\Varid{lenRight}))\mathbin{/}(\Varid{lenLeft}\mathbin{+}\Varid{lenRight}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\conj{\Varid{avgLTree}}{\Varid{lenLTree}}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\mathbin{*}\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\conj{\Varid{avgLTree}}{\Varid{lenLTree}},\conj{\Varid{avgLTree}}{\Varid{lenLTree}})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\Conid{A}\mathbin{*}\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}((\Conid{A}\mathbin{*}\Conid{A})\mathbin{*}(\Conid{A}\mathbin{*}\Conid{A}))} 
           \ar[l]^-{\ensuremath{\Varid{tree\char95 gen}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lenLTree}\;(\Conid{Leaf})\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{lenLTree}\;(\Conid{Fork}\;(\Varid{e},\Varid{d}))\mathrel{=}\Varid{lenLTree}\;\Varid{e}\mathbin{+}\Varid{lenLTree}\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
  \ensuremath{\begin{lcbr}\Varid{lenLTree}\;(\Conid{Leaf})\mathrel{=}\mathrm{1}\\\Varid{lenLTree}\;(\Conid{Fork}\;(\Varid{e},\Varid{d}))\mathrel{=}\Varid{lenLTree}\;\Varid{e}\mathbin{+}\Varid{lenLTree}\;\Varid{d}\end{lcbr}}
%
\just\equiv{ def.comp, def-const, def-x }
%
  \ensuremath{\begin{lcbr}(\Varid{lenLTree}\comp \Conid{Leaf})\;\Varid{x}\mathrel{=}\underline{\mathrm{1}}\;\Varid{x}\\(\Varid{lenLTree}\comp \Conid{Fork})\;(\Varid{e},\Varid{d})\mathrel{=}\uncurry{(\mathbin{+})}\comp (\Varid{lenLTree}\mathbin{*}\Varid{lenLTree})\;(\Varid{e},\Varid{d})\end{lcbr}}
%
\just\equiv{ def.split, def.proj,igualdade extensional }
%
\ensuremath{\begin{lcbr}(\Varid{lenLTree}\comp \Conid{Leaf})\mathrel{=}\underline{\mathrm{1}}\\(\Varid{lenLTree}\comp \Conid{Fork})\mathrel{=}\uncurry{(\mathbin{+})}\comp (\p2\comp \conj{\Varid{avgLTree}}{\Varid{lenLTree}},\p2\comp \conj{\Varid{avgLTree}}{\Varid{lenLTree}})\end{lcbr}}
%
\just\equiv{ def. inLtree, def.funtor-x, eq-+,def-fusao}
    \ensuremath{\Varid{lenLTree}\comp \Varid{inLtree}\mathrel{=}\alt{\underline{\mathrm{1}}}{\uncurry{(\mathbin{+})}\comp (\p2\mathbin{*}\p2)\comp (\conj{\Varid{avgLTree}}{\Varid{lenLTree}},\conj{\Varid{avgLTree}}{\Varid{lenLTree}})}}
%
\just\equiv{ def.absorçao-+,def-funtor,universal-cata}
    \ensuremath{\Varid{len}\mathrel{=}\llparenthesis\, \underline{\mathrm{1}},(\uncurry{(\mathbin{+})}\comp (\p2\mathbin{*}\p2))\,\rrparenthesis}
\qed
\end{eqnarray*}
...
\ttfamily ~open~Cp\\
\ttfamily ~\\
\ttfamily ~\char47{}\char47{}~\char40{}1\char41{}~Datatype~definition~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\ttfamily ~\\
...
\ttfamily ~~~~~\char124{}~Node~\char40{}y\char44{}\char40{}t1\char44{}t2\char41{}\char41{}~\char45{}\char62{}~i2~\char40{}y\char44{}\char40{}t1\char44{}t2\char41{}\char41{}\\
\ttfamily ~\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~inord~y~\char61{}~\\
\ttfamily ~~~~~~~~~let~join\char40{}x\char44{}\char40{}l\char44{}r\char41{}\char41{}\char61{}l\char64{}\char91{}x\char93{}\char64{}r\\
\ttfamily ~~~~~~~~~in~either~nil~join~y\\
\ttfamily ~~~\\
\ttfamily ~\\
\ttfamily ~let~inordt~x~\char61{}~cataBTree~\char40{}inord\char41{}~x\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~preordt~x~\char61{}~cataBTree~preord~x\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~rec~part~p~li~\char61{}\\
\ttfamily ~~~~~~~~match~li~with\\
\ttfamily ~~~~~~~~\char124{}\char91{}\char93{}~\char45{}\char62{}~\char40{}\char91{}\char93{}\char44{}\char91{}\char93{}\char41{}\\
\ttfamily ~~~~~~~~\char124{}\char40{}h\char58{}\char58{}t\char41{}~\char45{}\char62{}~if~not\char40{}p~h\char41{}~then~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}h\char58{}\char58{}s\char44{}l\char41{}~else~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}s\char44{}h\char58{}\char58{}l\char41{}~\\
\ttfamily ~\\
\ttfamily ~\\
\ttfamily ~let~qsep~li~\char61{}\\
\ttfamily ~~~~~match~li~with\\
\ttfamily ~~~~~\char124{}~\char91{}\char93{}~\char45{}\char62{}~i1~\char40{}\char41{}\\
\ttfamily ~~~~~\char124{}~\char40{}h\char58{}\char58{}t\char41{}~\char45{}\char62{}~i2\char40{}h\char44{}\char40{}part~\char40{}\char40{}\char60{}\char41{}~h\char41{}~t\char41{}~\char41{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~tunion\char40{}a\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~\char40{}List\char46{}map~\char40{}List\char46{}append~\char91{}a\char93{}\char41{}~l\char41{}\char64{}\char40{}List\char46{}map\char40{}List\char46{}append~\char91{}a\char93{}\char41{}~r\char41{}~\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~strategy~\char40{}d\char44{}x\char41{}~\char61{}~\\
\ttfamily ~~~~~~~~~match~x~with\\
\ttfamily ~~~~~~~~~\char124{}0~\char45{}\char62{}~Left~\char40{}\char41{}\\
\ttfamily ~~~~~~~~~\char124{}\char95{}~\char45{}\char62{}~Right~\char40{}\char40{}x\char45{}1\char44{}d\char41{}\char44{}\char40{}\char40{}not~d\char44{}x\char45{}1\char41{}\char44{}\char40{}not~d\char44{}x\char45{}1\char41{}\char41{}\char41{}\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~depthBTree~x~\char61{}~p2\char40{}baldepth~x\char41{}\\
\ttfamily ~let~balBTree~x~\char61{}~p1\char40{}baldepth~x\char41{}~
\end{tabbing}
