...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\underline{\Varid{a}}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g2}\mathrel{=}\alt{\Varid{id}}{\alt{\Varid{binOp}}{\Varid{unOp}}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{binOp}\;(\Conid{Sum},(\Varid{x},\Varid{y}))\mathrel{=}\Varid{x}\mathbin{+}\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{binOp}\;(\Conid{Product},(\Varid{x},\Varid{y}))\mathrel{=}\Varid{x}\mathbin{*}\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{unOp}\;(\Conid{Negate},\Varid{x})\mathrel{=}\Varid{negate}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{unOp}\;(\Conid{E},\Varid{x})\mathrel{=}\Varid{expd}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList}\;\alt{\conj{\Varid{singl}}{\underline{\mathrm{1}}}}{\conj{\Varid{gaux2}}{\Varid{g2}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{len}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{gaux2}\;(\Varid{x},(\Varid{avg},\Varid{len}))\mathrel{=}(\Varid{x}\mathbin{+}\Varid{len}\mathbin{*}\Varid{avg})\mathbin{/}(\mathrm{1}\mathbin{+}\Varid{len}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
